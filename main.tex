...
\autor{Nome completo do autor(a) 1 \\ Nome completo do autor(a) 2 \\ Nome completo do autor(a) 3 \\ Nome completo do autor(a) 4}
...
% orientador.
\orientador{Prof. Henrique Valle de Lima, Me.}
